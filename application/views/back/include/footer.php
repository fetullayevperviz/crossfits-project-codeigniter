...
<div class="font-13"><?php echo date('Y:m:d');?> By Perviz Fetullayev</div>
</footer>
        </div>
    </div>
    <!-- START SEARCH PANEL-->
                    ...
                    <div class="scroller">
                        <div class="media-list">
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u3.jpg" alt="image" width="40" />
                                </div>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u8.jpg" alt="image" width="40" />
                                </div>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u2.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u5.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u6.jpg" alt="image" width="40" />
                                </div>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u11.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u9.jpg" alt="image" width="40" />
                                </div>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u1.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u10.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                            ...
                            <a class="media" href="javascript:;" data-toggle="show-chat">
                                <div class="media-img">
                                    <img class="img-circle" src="<?=base_url('assets/back/');?>assets/img/users/u7.jpg" alt="image" width="40" />
                                </div>
                                <div class="media-body"><small class="float-right text-muted">12:05</small>
                        ...
                        <div class="scroller">
                            <div class="messenger-message">
                                <div class="message-image">
                                    <img src="<?=base_url('assets/back/');?>assets/img/users/u8.jpg" alt="image" />
                                </div>
                            ...
                            <div class="messenger-message">
                                ...
                                <div class="message-body">
                                    ...
                                    <div class="mb-3">
                                        <img src="<?=base_url('assets/back/');?>assets/img/blog/culinary-1.jpg" alt="image" />
                                    </div>
                                    <div>
                                        <img src="<?=base_url('assets/back/');?>assets/img/blog/01.jpg" alt="image" />
                                    </div>
                                </div>
                            </div>
                            <div class="messenger-message messenger-message-answer">
    ...
    <script src="<?=base_url('assets/back/');?>assets/vendors/chart.js/dist/Chart.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/morris.js/morris.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/raphael/raphael.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/vendors/peity/jquery.peity.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/js/scripts/widgets-demo.js"></script>

    <script src="<?=base_url('assets/back/');?>assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/js/app.min.js"></script>
    <script src="<?=base_url('assets/back/');?>assets/js/scripts/dashboard_visitors.js"></script>
