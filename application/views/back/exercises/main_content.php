...
<div class="page-content fade-in-up">
          ...
          <div class="card">
              ...
              <h3 class="card-title">Məşqlər Qalereyası</h3>
              <a href="<?=base_url('admin/exercises_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
          </div>  
            <div class="card-body">
                ...
                <tbody>
                  <?php $num = 1; foreach ($info as $info): ?>
                     <tr class="text-center">
                        ...
                        <td>
                          <a href="<?=base_url('admin/exercises_update/'.$info["id"].'');?>">
                            <button type="button" class="btn btn-success" name="button">Yenilə</button>
                          <a href="<?=base_url('admin/exercises_delete/'.$info["id"].'/id/exercises');?>">
