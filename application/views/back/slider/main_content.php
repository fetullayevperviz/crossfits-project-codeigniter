...
<div class="page-content fade-in-up">
          ...
          <div class="card">
              ...
              <a href="<?=base_url('admin/slider_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
          </div>  
            <div class="card-body">
              <table id="myTable" class="table table-bordered table-striped table-responsive">
                ...
                <tr>
                  ...
                  <th class="text-center">1.Slider Mətni</th>
                  <th class="text-center">2.Slider Mətni</th>
                ...
                <tbody>
                  <?php $num = 1; foreach ($info as $info): ?>
                     <tr class="text-center">
                        ...
                        <td><?= substr($info['image_text2'], 0,20);?></td>
                        <td><?= substr($info['image_text2'], 0,20);?></td>
                        <td>
                        ...
                        <td>
                          <a href="<?=base_url('admin/slider_update/'.$info["id"].'');?>">
                            <button type="button" class="btn btn-success" name="button">Yenilə</button>
                          <a href="<?=base_url('admin/slider_delete/'.$info["id"].'/id/slider');?>">
