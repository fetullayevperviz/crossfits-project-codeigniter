...
<div class="page-content fade-in-up">
	<div class="card card-info  bg-dark text-white">
      ...
      <form class="form-horizontal" autocomplete="off" enctype="multipart/form-data" method="POST" action="<?=base_url('admin/amin_tursu_insert');?>">
        <div class="card-body">
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-primary">
          	 <a href="<?=base_url('admin/amin_tursulari');?>" style="color:white;">Geri Qayıt</a>
          </button>
