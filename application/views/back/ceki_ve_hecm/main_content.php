...
<div class="page-content fade-in-up">
          ...
          <div class="card">
              ...
              <h3 class="card-title">Çəki və Həcm Proteinləri Listi</h3>
              <a href="<?=base_url('admin/ceki_ve_hecm_add');?>" class="btn btn-primary float-right">
                ...
                <tbody>
                  <?php $num = 1; foreach ($info as $info): ?>
                     <tr class="text-center">
                        ...
                        <td>
                          <a href="<?=base_url('admin/ceki_ve_hecm_update/'.$info["id"].'');?>">
                            <button type="button" class="btn btn-success" name="button">Yenilə</button>
                          <a href="<?=base_url('admin/ceki_ve_hecm_delete/'.$info["id"].'/id/ceki_hecm');?>">
