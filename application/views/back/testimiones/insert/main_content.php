...
<div class="page-content fade-in-up">
	<div class="card card-info bg-dark text-white">
      <div class="card-header">
        <h3 class="card-title">Şəhadətnamə Əlavə Etmə Formu</h3>
      </div>
      <form class="form-horizontal" autocomplete="off" enctype="multipart/form-data" method="POST" action="<?=base_url('admin/testimiones_insert');?>">
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
             <textarea name="info" cols="30" rows="10" class="form-control" placeholder="Haqqında Məlumat Yazın"></textarea>
            </div>
          </div>
