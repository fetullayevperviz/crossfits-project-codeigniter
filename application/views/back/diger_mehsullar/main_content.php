...
<div class="page-content fade-in-up">
          ...
          <div class="card">
              ...
              <h3 class="card-title">Digər Məhsullar Listi</h3>
              <a href="<?=base_url('admin/diger_mehsullar_add');?>" class="btn btn-primary float-right">
                ...
                <tbody>
                  <?php $num = 1; foreach ($info as $info): ?>
                     <tr class="text-center">
                        ...
                        <td><?= substr($info['protein_name'], 0,20);?></td>
                        ...
                        <td>
                          <a href="<?=base_url('admin/diger_mehsullar_update/'.$info["id"].'');?>">
                            <button type="button" class="btn btn-success" name="button">Yenilə</button>
                          <a href="<?=base_url('admin/diger_mehsullar_delete/'.$info["id"].'/id/diger_mehsullar');?>">
