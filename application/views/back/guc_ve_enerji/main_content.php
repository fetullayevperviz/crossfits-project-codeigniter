...
<div class="page-content fade-in-up">
          ...
          <div class="card">
              ...
              <h3 class="card-title">Güc və Enerji Proteinləri Listi</h3>
              <a href="<?=base_url('admin/guc_enerji_add');?>" class="btn btn-primary float-right">
                ...
                <tbody>
                  <?php $num = 1; foreach ($info as $info): ?>
                     <tr class="text-center">
                        ...
                        <td>
                          <a href="<?=base_url('admin/guc_enerji_update/'.$info["id"].'');?>">
                            <button type="button" class="btn btn-success" name="button">Yenilə</button>
                          <a href="<?=base_url('admin/guc_enerji_delete/'.$info["id"].'/id/guc_enerji');?>">
