...
<div class="page-content fade-in-up">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Trinerlər</h3>
               <a href="<?=base_url('admin/triner_add');?>" class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Əlavə Et</a>
            </div>
                ...
                <tbody>
                    <?php $num=1; foreach ($info as $info): ?>
                      <tr class="text-center">
                          ...
                          <td>
                            <a href="<?=base_url('admin/triner_update/'.$info['id'].'');?>">
                              <button type="button" class="btn btn-success" name="button">Yenilə</button>
                            </a>
                            <a href="<?=base_url('admin/triner_delete/'.$info["id"].'/id/triner');?>">
